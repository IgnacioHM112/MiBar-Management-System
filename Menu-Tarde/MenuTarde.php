...
<body>
    <div class="container py-5">
        <div class="text-center mb-5">
            <h1 class="display-4 font-weight-bold text-success">MENÚ DE TARDE</h1>
            <p class="lead text-muted">Disfruta de nuestras tardes y noches en Mi Bar</p>
        </div>

        <div class="row mb-4">
            <div class="col-md-6">
                <input type="text" class="form-control shadow-sm" placeholder="¿Qué se te antoja hoy?..." value="<?php echo htmlspecialchars($busqueda); ?>" onchange="busqueda(this.value)">
            </div>
            <div class="col text-right">
                <a href="../index.php" class="btn btn-success shadow-sm">Volver al Inicio</a>
            </div>
        </div>
                ...
                <div class="col-md-3 mb-4">
                    <div class="card h-100 shadow-sm border-0 transition-hover">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text text-success font-weight-bold h5">$<?php echo number_format($item['precio'], 2); ?></p>
                        </div>
                    </div>
                </div>
            <?php } } else { ?>
