...
$limit = 12; // Increased to show more products
...
<head>
    ...
    <!-- Using our new modern style -->
    <link rel="stylesheet" href="../PagPrincipal/CSS/modern-style.css">
    
    <style>
        .menu-header {
            background: linear-gradient(rgba(0,0,0,0.5), rgba(0,0,0,0.5)), url('fondo-menu.jpg');
...
<body style="background-color: #f8f9fa;">
    ...
    <div class="menu-header">
        <h1 style="font-size: 3.5rem; font-weight: 900;">MENÚ MAÑANA</h1>
        <p style="opacity: 0.8; font-size: 1.2rem;">Comenzá el día con energía</p>
    </div>

    <div class="container" style="max-width: 1200px; margin: 0 auto; padding: 0 20px;">
        <div class="search-bar">
            <input type="text" placeholder="¿Qué se te antoja hoy?..." value="<?php echo htmlspecialchars($busqueda); ?>" onchange="busqueda(this.value)">
        </div>
